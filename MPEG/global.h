...
/* readpic.c */
int readframe _ANSI_ARGS_((char *fname, unsigned char *frame[], int FrameNumber));
...
EXTERN unsigned char ClippingTable[1024];
...
EXTERN int FrameWidth, FrameHeight; /* encoded frame size (pels) multiples of 16 or 32 */

...
INT_PTR CALLBACK FourierTypeDlg (HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
     {
...
INT_PTR CALLBACK FourierAnimDlg (HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
     {
     char		*fileptr;
     HWND		hCtrl;
     BOOL		TempCheck;

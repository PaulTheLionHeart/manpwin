...
void	CPixel::CalcQDFloatIteration(double error, std::vector <float> &wpixels, int row, int col, QDComplex z, QDComplex OldZ, QDComplex OlderZ, double FloatIteration, WORD type, int subtype, WORD *degree, BYTE SpecialFlag, WORD special, int width)
    {
    double	log_zn, nu, t;

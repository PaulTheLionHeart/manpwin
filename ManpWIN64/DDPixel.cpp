...
void	CPixel::CalcDDFloatIteration(double error, std::vector <float> &wpixels, int row, int col, DDComplex z, DDComplex OldZ, DDComplex OlderZ, double FloatIteration, WORD type, int subtype, WORD *degree, BYTE SpecialFlag, WORD special, int width)
    {
    double	log_zn, nu, t;

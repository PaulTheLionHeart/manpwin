/*
    QDTrig.cpp - C routines for big floating point trig functions
    Wesley Loewer's Big Numbers.     (C) 1994-95, Wesley B. Loewer

    This allows an alternative for multi-threading where trig functions fail using quad-double arithmetic
